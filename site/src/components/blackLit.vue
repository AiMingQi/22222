<template>
  <v-container>
    <v-row class="text-center">
      <v-col class="mb-4">
      <v-card>
        <v-btn @click="enterBlack" block color="black" dark>
          Black Card Members Only
        </v-btn>
      </v-card>
      </v-col>      
    </v-row>
    ...
    methods: {
      ...
      async getLit () {
        ...
        this.accessControlConditions = [
          {
            ...
            parameters: [
              ':userAddress',
              '106728893711997430351499537110311918968148144763278714921562000175685080973314'
            ],
            returnValueTest: {
              comparator: '>',
              value: '0'
        ...
        this.resourceId = {
          ...
          orgId: "",
          role: "",
          extraData: "black-opensea-v6-world"
        }
      },
      async getAuthSig () {
      ...
      async verifyJwt () {
        ...
        this.$store.state.blackVerified = true
